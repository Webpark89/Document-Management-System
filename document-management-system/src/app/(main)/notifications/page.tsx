...
// Extended mock notifications for the center
// Event types matching requirements: new, pending, approved, returned, cancelled
...
export default function NotificationsPage() {
  const [notifications, setNotifications] = useState<NotificationExt[]>(INITIAL_NOTIFICATIONS);
        ...
        <div className="flex flex-col divide-y divide-slate-100">
          {filteredNotifs.length === 0 ? (
            ...
            filteredNotifs.map(n => (
              <Link 
                key={n.id}
                href={n.type === "pending" ? `/approvals/${n.document_id}` : `/documents/${n.document_id}`}
